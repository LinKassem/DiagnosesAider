...
<html>
  ...
  <%
	...
	da.populateModel();
  	...
  	//place the da object in a session attribute
  ...
  <body>
    <div class="container">
      ...
      <div class="jumbotron">
        <h2>Welcome To Diagnosis Aider!</h2>
        <br>
        <form class="form-inline" action="patient.jsp" method="GET">
          <div class="form-group">
            <label for="patient_id"><p>Patient ID: </p></label>
            <input style="margin-bottom:5px;" type="text" class="form-control" name="patient_id" placeholder="Patient ID">
          </div>
